...
**16 tools with 190 operations across 16 domains:**
...
| `shape` | 50 | shape creation, styling, grouping, hyperlinks, placeholders, string tags, `copy-formatting`, `duplicate`, `copy-to-slide`, `get-link-info`, `update-link`, `break-link`, `set-link-auto-update` |
