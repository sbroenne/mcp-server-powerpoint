...
| `shape` | 49 | shape creation, alignment/distribution, styling, grouping, hyperlinks, placeholders, string tags, `get-link-info`, `update-link`, `break-link`, `set-link-auto-update` |
