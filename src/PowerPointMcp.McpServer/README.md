...
| `shape` | 50 | shape creation, editable WordArt, styling, per-axis 3D rotation, grouping, hyperlinks, placeholders, string tags, `get-link-info`, `update-link`, `break-link`, `set-link-auto-update` |
