...
**16 tools with 191 operations across 16 domains:**
...
| `shape` | 51 | shape creation, editable WordArt, styling, per-axis 3D rotation, grouping, hyperlinks, placeholders, string tags, `copy-formatting`, `get-link-info`, `update-link`, `break-link`, `set-link-auto-update` |
