...
**16 MCP tools with 190 operations across 16 domains:**
...
- ▭ **Shape** (50 ops) — shapes, alignment/distribution, styling, grouping, hyperlinks, linked assets, placeholder editing,
  and string tags
