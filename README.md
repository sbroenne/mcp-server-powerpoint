...
**16 MCP tools with 189 operations across 16 domains:**
...
- ▭ **Shape** (49 ops) — shapes, alignment/distribution, styling, grouping, hyperlinks, linked assets, placeholder editing,
  and string tags
