...
description: 16 MCP tools with 191 operations across 16 domains for live PowerPoint automation through single action-dispatch tools.
...
PowerPoint MCP Server exposes **16 MCP tools with 191 operations across 16 domains**.
...
| `shape` | 51 | Shapes, styling, grouping, hyperlinks, linked pictures, placeholders, string tags | `shape(action="...", session_id=..., ...)` | `pptcli shape <action> -s <SESSION_ID> ...` |
